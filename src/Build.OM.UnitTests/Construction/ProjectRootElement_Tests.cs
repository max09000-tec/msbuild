...
<Project ToolsVersion=""msbuilddefaulttoolsversion"" xmlns=""msbuildnamespace"">
  <ItemGroup>
    <i Include=""@(h->'%(x)')"" />
        ...
        {
            using var xmlReader1 = XmlReader.Create(new StringReader(ObjectModelHelpers.CleanupFileContents(@"<?xml version=""1.0"" encoding=""utf-16""?>
<Project DefaultTargets=""Build"" ToolsVersion=""msbuilddefaulttoolsversion"" xmlns=""msbuildnamespace"">
</Project>")));
            ProjectRootElement project = ProjectRootElement.Create(xmlReader1);
            Assert.Equal(Encoding.Unicode, project.Encoding);
            using var xmlReader2 = XmlReader.Create(new StringReader(ObjectModelHelpers.CleanupFileContents(@"<?xml version=""1.0"" encoding=""utf-8""?>
<Project DefaultTargets=""Build"" ToolsVersion=""msbuilddefaulttoolsversion"" xmlns=""msbuildnamespace"">
</Project>")));
            project = ProjectRootElement.Create(xmlReader2);
            Assert.Equal(Encoding.UTF8, project.Encoding);

            using var xmlReader3 = XmlReader.Create(new StringReader(ObjectModelHelpers.CleanupFileContents(@"<?xml version=""1.0"" encoding=""us-ascii""?>
<Project DefaultTargets=""Build"" ToolsVersion=""msbuilddefaulttoolsversion"" xmlns=""msbuildnamespace"">
</Project>")));
            project = ProjectRootElement.Create(xmlReader3);
    ...
    <i Include=`a`>
      <m>metadata value</m>
        ...
        private void SaveProjectWithEncoding(string projectFullPath, Encoding encoding)
        {
            ...
            ProjectRootElement project = ProjectRootElement.Open(projectFullPath, pc);
            ...
            project = ProjectRootElement.Open(projectFullPath, pc2);
